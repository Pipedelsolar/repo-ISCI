...
# df_vrs_match_case, _ = call_data_2025_update(path='COHORTE_NIRSE_ACTUALIZADA_04_03_2026_ENC.csv',
...
# df_vrs_match_case.to_csv(path_data/'df_vrs_match_case_2025_04_03_2026.csv',index=False)

df_vrs_match_case = pd.read_csv(path_data/'df_vrs_match_case_2025_04_03_2026.csv')
...
with pd.ExcelWriter(path_data/"resultados_comparados_2025.xlsx", engine="openpyxl", mode="a", if_sheet_exists="replace") as writer:
    df_final.to_excel(writer, sheet_name=f"T2_all_born_{ratio_selected.split(':')[1]}") #Tabla_2_ratio_1_1_unif_upc   Tabla_2_1a7_francia_oficial
